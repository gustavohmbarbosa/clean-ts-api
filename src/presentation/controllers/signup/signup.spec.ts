...
describe('SignUp Controller', () => {
  ...
  test('should return 400 if password and password confirmation are not equals', async () => {
    const { sut } = makeSut()
    const HttpRequest = {
      body: {
        name: 'any_name',
  ...
  test('should return a bad request if an email invalid is provided', async () => {
